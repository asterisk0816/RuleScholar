...
file_path = '/home/example/server/ChatGPT Web App（新Googleサイト用） - パスワード自動変更.csv'

# 毎日午後11時30分にファイル送信関数をスケジュール
schedule.every().day.at("23:30").do(send_file_to_discord, file_path=file_path, webhook_url=webhook_url)
